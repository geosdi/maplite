 ...
 */
@RemoteServiceRelativePath("MapLiteServiceRemote")
public interface MapLiteServiceRemote extends RemoteService {

    public static class Util {

        private static MapLiteServiceRemoteAsync instance;

        public static MapLiteServiceRemoteAsync getInstance() {
            if (instance == null) {
                instance = (MapLiteServiceRemoteAsync) GWT.create(
                        MapLiteServiceRemote.class);
            }
