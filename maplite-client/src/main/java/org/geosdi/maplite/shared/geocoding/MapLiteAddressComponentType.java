 ...
 */
public enum MapLiteAddressComponentType implements Serializable {
    ...
    private static Logger log = Logger.getLogger(MapLiteAddressComponentType.class.getName());

    private String addressComponentType;

    private MapLiteAddressComponentType() {
    }

    MapLiteAddressComponentType(String addressComponentType) {
    ...
    public static MapLiteAddressComponentType lookup(String addressComponentType) {
