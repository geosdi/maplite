 ...
 */
public enum MapLiteAddressType implements Serializable {
    ...
    private static Logger log = Logger.getLogger(MapLiteAddressType.class.getName());

    private String addressType;

    private MapLiteAddressType() {
    }

    MapLiteAddressType(String addressType) {
...
//    @Override
    ...
    public static MapLiteAddressType lookup(String addressType) {
