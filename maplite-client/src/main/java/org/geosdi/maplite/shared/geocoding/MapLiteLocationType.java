 ...
 * more detail</a>.
 */
public enum MapLiteLocationType implements Serializable {
    ...
    private static Logger log = Logger.getLogger(MapLiteLocationType.class.getName());
...
//    @Override
    ...
    public MapLiteLocationType lookup(String locationType) {
